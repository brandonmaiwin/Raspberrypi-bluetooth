...
class speedViewController: UIViewController, CBPeripheralManagerDelegate, UITextViewDelegate, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        //Formatting of the ui text fields
    ...
    //sends data when ardino is on or off, sends a value of one
